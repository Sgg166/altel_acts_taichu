void  good_Track_per_event(const std::string& rootFilePath){
  ...
  TH1F *hGoodTrajectoriesPerEvent = new TH1F("hGoodTrajectoriesPerEvent","Number of Good Trajectories per Event;Good Trajectories per Event;Number of Events",  20, 0, 10);

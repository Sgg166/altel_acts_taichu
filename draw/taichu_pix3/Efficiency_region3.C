void Efficiency_region3(const std::string& rootFilePath){
    ...
    TEfficiency* pEff2D = new TEfficiency("eff2D","Efficiency vs Position;u [mm 16bin];v [mm 8bin];Efficiency",nBinsU, region_u_min, region_u_max, nBinsV, region_v_min, region_v_max);
    ...
    TH2I* hMatchedCount = new TH2I("hMatchedCount", "Matched Track count per bin;u [mm 32bin];v [mm 16bin];Count",nBinsU, region_u_min, region_u_max,nBinsV, region_v_min, region_v_max);
...
//    pEffV->SetStats(1);
   ...
   // gPad->SetPaintTextFormat(".2f");
    ...
    TFile *outFile = new TFile("/home/pub/B/altel_acts/Draw/root_file/efficiency_projections.root", "RECREATE");
    c1->Write();
    c2->Write();
    pEff2D->Write();
    hTrackCount->Write();
    ...
    pEffV->Write();
    outFile->Close();
    c1->SaveAs("/home/pub/B/altel_acts/Draw/save_svg/efficiency_projections.svg");

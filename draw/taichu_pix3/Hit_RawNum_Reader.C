void  Hit_RawNum_Reader(const std::string& rootFilePath){
  ...
  TH1F* hClaster_RawNum_det2  = new TH1F("hClaster_RawNum_det2", "The number of raw pixels contained in each cluster in detID 2", 16, 0, 8);
  TH1F* hClaster_RawNum_det3  = new TH1F("hClaster_RawNum_det3", "The number of raw pixels contained in each cluster in detID 3", 16, 0, 8);
  TH1F* hClaster_RawNum_det32 = new TH1F("hClaster_RawNum_det32", "The number of raw pixels contained in each cluster in detID 32",16,0, 8);
  TH1F* hClaster_RawNum_det5  = new TH1F("hClaster_RawNum_det5", "The number of raw pixels contained in each cluster in detID 5", 16, 0, 8);
  TH1F* hClaster_RawNum_det7  = new TH1F("hClaster_RawNum_det7", "The number of raw pixels contained in each cluster in detID 7", 16, 0, 8);
  TH1F* hClaster_RawNum_det9  = new TH1F("hClaster_RawNum_det9", "The number of raw pixels contained in each cluster in detID 9", 16, 0, 8);
      ...
      for(size_t i = 0; i < measHits.size(); i++){
        ...
        if(detID == 2)
        {
         ...
         // std::cout<<" numRaws : "<<numRaws<<std::endl;
          ...
          hClaster_RawNum_det3 ->Fill(numRaws);
        }
        else if(detID == 32)
        {
         ...
         // hHitCount_det32->Fill(det32_event_hit_count);
          ...
          hClaster_RawNum_det5 ->Fill(numRaws);
        }
        else if(detID == 7 ){ 
          hClaster_RawNum_det7 ->Fill(numRaws);
        }
        else if(detID == 9 ){
          hClaster_RawNum_det9 ->Fill(numRaws);
        }
      }
    }
  }
  ...
  hClaster_RawNum_det2->SetFillColor(kRed);
  hClaster_RawNum_det2->SetStats(1);
  gStyle->SetOptStat(1111);
  gStyle->SetStatX(0.9);
  //gStyle->SetTextSize(1);
  gStyle->SetPaintTextFormat(".2f");
  hClaster_RawNum_det2->SetMarkerSize(1.5);
  ...
  hClaster_RawNum_det2->Draw("HIST TEXT0");
  
  c1->cd(2);
  //hClaster_RawNum_det3->SetLineColor(kBlue);
  hClaster_RawNum_det3->SetFillColor(kBlue);
  hClaster_RawNum_det3->SetMarkerSize(1.5);
  ...
  hClaster_RawNum_det3->Draw("HIST TEXT0");
  
  c1->cd(3);
  //hClaster_RawNum_det32->SetLineColor(kViolet);
  hClaster_RawNum_det32->SetFillColor(kViolet);
  hClaster_RawNum_det32->SetMarkerSize(1.5);
  ...
  hClaster_RawNum_det32->Draw("HIST TEXT0");
  
  c1->cd(4);
 // hClaster_RawNum_det5->SetLineColor(kGreen);
  hClaster_RawNum_det5->SetFillColor(kGreen);
  hClaster_RawNum_det5->SetMarkerSize(1.5);
  ...
  hClaster_RawNum_det5->Draw("HIST TEXT0");
  
  c1->cd(5);
  //hClaster_RawNum_det7->SetLineColor(kMagenta);
  hClaster_RawNum_det7->SetFillColor(kMagenta);
  hClaster_RawNum_det7->SetMarkerSize(1.5);
  ...
  hClaster_RawNum_det7->Draw("HIST TEXT0");
  
  c1->cd(6);
 // hClaster_RawNum_det9->SetLineColor(kOrange);
  hClaster_RawNum_det9->SetFillColor(kOrange);
  hClaster_RawNum_det9->SetMarkerSize(1.5);
  ...
  hClaster_RawNum_det9->Draw("HIST TEXT0");

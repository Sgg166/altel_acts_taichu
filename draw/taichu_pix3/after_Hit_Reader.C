...
//  TH1F *hNumOriginHits_det32 = new TH1F("hNumOriginHits_det32", "good_fit_origin_Claster_size_det 32", 30, 0, 15);
  ...
  TH2F *cluster_u_Residual_det2 = new TH2F("cluster_u_Residual_det2", "cluster_u_Residual_det 2", 200, -12.8,12.8, 200, -0.02, 0.02 );
  TH2F *cluster_u_Residual_det3 = new TH2F("cluster_u_Residual_det3", "cluster_u_Residual_det 3", 200, -12.8,12.8, 200, -0.02, 0.02 );
  TH2F *cluster_u_Residual_det5 = new TH2F("cluster_u_Residual_det5", "cluster_u_Residual_det 5", 200, -12.8,12.8, 200, -0.02, 0.02 );
  TH2F *cluster_u_Residual_det7 = new TH2F("cluster_u_Residual_det7", "cluster_u_Residual_det 7", 200, -12.8,12.8, 200, -0.02, 0.02 );
  TH2F *cluster_u_Residual_det9 = new TH2F("cluster_u_Residual_det9", "cluster_u_Residual_det 9", 200, -12.8,12.8, 200, -0.02, 0.02 );

  TH2F *cluster_v_Residual_det2 = new TH2F("cluster_v_Residual_det2", "cluster_v_Residual_det 2", 200, -6.4,6.4, 200, -0.02, 0.02 );
  TH2F *cluster_v_Residual_det3 = new TH2F("cluster_v_Residual_det3", "cluster_v_Residual_det 3", 200, -6.4,6.4, 200, -0.02, 0.02 );
  TH2F *cluster_v_Residual_det5 = new TH2F("cluster_v_Residual_det5", "cluster_v_Residual_det 5", 200, -6.4,6.4, 200, -0.02, 0.02 );
  TH2F *cluster_v_Residual_det7 = new TH2F("cluster_v_Residual_det7", "cluster_v_Residual_det 7", 200, -6.4,6.4, 200, -0.02, 0.02 );
  TH2F *cluster_v_Residual_det9 = new TH2F("cluster_v_Residual_det9", "cluster_v_Residual_det 9", 200, -6.4,6.4, 200, -0.02, 0.02 );
  ...
  cluster_u_Residual_det2->Draw("COLZ");
  ...
  cluster_v_Residual_det2->Draw("COLZ");
...
//  gStyle->SetOptFit(1111);
  ...
  cluster_u_Residual_det3->Draw("COLZ");
  ...
  cluster_v_Residual_det3->Draw("COLZ");
...
*/
  ...
  cluster_u_Residual_det5->Draw("COLZ");
  ...
  cluster_v_Residual_det5->Draw("COLZ");
...
//  gStyle->SetOptFit(1111);
  ...
  cluster_u_Residual_det7->Draw("COLZ");
  ...
  cluster_v_Residual_det7->Draw("COLZ");
...
//  gStyle->SetOptFit(1111);
  ...
  cluster_u_Residual_det9->Draw("COLZ");
  ...
  cluster_v_Residual_det9->Draw("COLZ");

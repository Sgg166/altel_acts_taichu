void after_Hit_U_V_TH2F(const std::string& rootFilePath){
  ...
  TH2F* huv_cluster_det2  = new TH2F("huv_cluster_det2" , "Origin_Cluster UV Distribution det2"  , 50, -12.8, 12.8, 50, -6.4, 6.4);
  TH2F* huv_cluster_det3  = new TH2F("huv_cluster_det3" , "Origin_Cluster UV Distribution det3"  , 50, -12.8, 12.8, 50, -6.61, 6.19);
  TH2F* huv_cluster_det32 = new TH2F("huv_cluster_det32", "Matched_Cluster UV Distribution det32", 50, -11.6, 14, 50, -5.5, 7.3);
  TH2F* huv_cluster_det5  = new TH2F("huv_cluster_det5" , "Origin_Cluster UV Distribution det5"  , 50, -12.82, 12.78, 50, -7.5, 5.3);
  TH2F* huv_cluster_det7  = new TH2F("huv_cluster_det7" , "Origin_Cluster UV Distribution det7"  , 50, -12.97, 12.68, 50, -6, 6.8);
  TH2F* huv_cluster_det9  = new TH2F("huv_cluster_det9" , "Origin_Cluster UV Distribution det9"  , 50, -12.8, 12.8, 50, -6.4, 6.4);
 
  TH2F* huv_fit_det32 = new TH2F("huv_fit_det32", "huv_fit_det32; fit_u; fit_v", 50, -11.6, 14, 50, -5.5, 7.3);
  ...
  std::fprintf(stdout, "totalNumEvents: %zu\n", totalNumEvents);

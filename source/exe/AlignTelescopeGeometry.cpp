...
int main(int argc, char *argv[]) {
  ...
  Telescope::BuildGeometry(gctx, trackingGeometry, element_col, geoconf, 50_mm,
                           25_mm, 80_um);
...

  {
    ...
    while (1) {
      ...
      Telescope::TelescopeJsonTrackReader::createSourcelinksFromJSON(
          evpack, surfaces_selected, cov_hit, sourcelinks);

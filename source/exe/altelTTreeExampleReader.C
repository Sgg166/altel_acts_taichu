...
//       gROOT->ProcessLine(".include source/teldata/event/include/");
//       gROOT->ProcessLine(".include source/teldata/root/include/");
//       gROOT->ProcessLine(".L source/teldata/root/src/TelEventTTreeReader.cpp");
// 2. run root macro in the same folder of rootlogon.C
//       >> root altelTTreeExampleReader.C


void altelTTreeExampleReader(){
  // root file is output of altelActsTrack
